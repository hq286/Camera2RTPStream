...
//        mSurfaceHolder = mSurfaceView.getHolder(); // TODO: surfaceHolder not getting called
...
//        mSurfaceHolder.addCallback(mSurfaceHolderCallback);
    ...
    public static Size chooseOptimalSize(
        ...
        for (final Size option : choices) {
            Log.i(TAG, "Size: " + option.getWidth() + "x" + option.getHeight());
        ...
        Log.i(TAG, "Desired size: " + desiredSize + ", min size: " + minSize);
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            Size mPreviewSize = chooseOptimalSize(
    ...
    public void configureEncoder() throws IOException {
        ...
        mPacketizer.setDestination(IP, PORT, 19400);
...
//                List<Surface> mSurfaces = Arrays.asList(mSurfaceHolder.getSurface(), mediaCodecSurface);
